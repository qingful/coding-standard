# 使用方式：
# 1.将当前文件放到代码文件夹根目录,命令行启动
# 2.文件package.json, scripts: {"eslint": "eslint ./app", "eslint-fix": "eslint --fix ./app"}
# 3.文件package.json, pre-commit: ["eslint"]

yarn add eslint prettier pre-commit eslint-config-prettier eslint-plugin-prettier --dev
